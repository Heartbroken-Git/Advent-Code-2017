...
// PART ONE
int answerPartOne(const int input[NB_ROWS][NB_COLS]) {
    int results = 0;
...
// PART TWO
int returnDivided(const int row[NB_COLS]) {
...
int answerPartTwo(const int input[NB_ROWS][NB_COLS]) {
    int results = 0;
    for (int i = 0; i < NB_ROWS; i++) {
        results += returnDivided(INPUT[i]);
    }
...
// MAIN
int main() {
    cout << "Answer for Part One = " << answerPartOne(INPUT) << endl;
    cout << "Answer for Part Two = " << answerPartTwo(INPUT) << endl;
